...
export const simpleSchemaContract = object({
  name_client: string().required().matches(/^[a-zA-Z ]*$/, { message: "Apenas letras" }).label("Nome"),
...
export const simpleSchemaReservation = object({
  ...
  nameCard: string().matches(/^[a-zA-Z ]*$/, { message: "Apenas letras" }).nullable(),
...
export const simpleSchemaPassenger = object({
  passageiro: string().matches(/^[a-zA-Z ]*$/, { message: "Apenas letras" }).required(),
});

export const simpleSchemaInformationUser = object({
  fullName: string().required().matches(/^[a-zA-Z ]*$/, { message: "Apenas letras" }).label("Nome completo"),
