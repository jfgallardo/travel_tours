  ...
  <div class="bg-gray-200">
    <div class="container mx-auto px-4 py-20">
      <div class="space-y-10">
        ...
        <div class="text-sm flex space-x-1 justify-center">
          <p class="px-8 text-center">
            Muito obrigado por nos escolher, pode deixar uma grande saudação aqui
            <span class="flex items-center justify-center space-x-1">
              <ArrowCircleRight class="h-5 w-5" />
              <span class="text-blue-700"> <a href="mailito:ola@mrtravelandtours.com?subject=Ola MTravel">ola@mrtravelandtours.com</a> </span>
            </span>
          </p>
        </div>
      </div>
