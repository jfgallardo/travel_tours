<template>
    <div>
        <div class="grid grid-cols-3 grid-rows-1">
            <button ref="cheap" class="py-3 border border-gray-400 relative" @click="filter(cheap)">
            ...
            <button ref="fast" class="py-3 border-y border-gray-400 relative" @click="filter(fast)">
                <div class="flex flex-col items-center font-medium">
            ...
            <button ref="premium" class="py-3 border border-gray-400 relative" @click="filter(premium)">
                <div class="flex flex-col items-center font-medium">
