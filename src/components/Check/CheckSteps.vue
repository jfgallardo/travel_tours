<template>
  <form>
    ...
    <div class="flex items-center justify-center space-x-6 mt-10">
      <button 
          v-if="auth.currentStepPayment > 0" type="button" class="bg-gray-200 hover:bg-gray-300 py-2 px-10"
          @click="backStep">
            Retornar
      </button>
      <button 
      ...
      <button v-if="auth.currentStepPayment === 4" class="bg-blue-700 hover:bg-blue-800 text-white py-2 px-10" disabled>
        Verifica Agora
      </button>
    </div>
  </form>
