    ...
    <div class="flex items-stretch space-x-12 pt-4 px-8">
      <div class="flex flex-col w-full border border-gray-300">
        <div class="border-b py-2 px-4">
          <div
            class="h-4 w-28 font-medium bg-slate-200 rounded animate-pulse"
          ></div>
        </div>
        <div>
          <div class="animate-pulse flex items-center space-x-4 p-8">
      ...
      <div class="w-1/5 border border-gray-300 shrink-0 relative">
        <div class="animate-pulse flex flex-col space-y-4 p-8">
          <div class="flex-1 space-y-6 py-1">
            <div class="h-2 bg-slate-200 rounded"></div>
            <div class="space-y-3">
              <div class="grid grid-cols-3 gap-4">
