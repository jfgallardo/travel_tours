    ...
    <div class="mx-auto px-4 pb-10">
      <div class="flex">
        ...
        <div class="basis-4/12 flex flex-col mx-auto p-8">
          ...
          <div class="flex">
            <RouterLink class="bg-blue-700 hover:bg-blue-800 text-white mt-5 py-2 w-1/2 flex items-center justify-center" :to="{name: 'CheckoutPage'}">Comprar agora</RouterLink>
          </div>
        </div>
      </div>
      <div class="flex">
...
const valorTotal = computed(() => {
  return currencyFormatter({
    currency: 'BRL',
    value: userStore.vooSelected.ValorTotal,
  });
});
const valorTotalTaxas = computed(() => {
  return currencyFormatter({
    currency: 'BRL',
    value: userStore.vooSelected.ValorTotalTaxas,
  });
});
