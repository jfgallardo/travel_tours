            ...
            <div class="space-y-9">
                <Form @submit="onSubmit" v-slot="{ setFieldValue, values }" :initial-values="formValues">
                    <div class="grid grid-cols-4 grid-rows-4 gap-6">
                        ...
                        <TextInput nameValue="transactionValue" rulesValue="required" label="VALOR DA TRANSAÇÃO"
                            maska="#*.##" />
                        ...
                        <TextInput nameValue="numberParcela" maska="##" rulesValue="required" label="Nº DE PARCELAS"
                            @input="
                                setFieldValue(
                                    'restosParcelas',
                                    calculate(
                ...
                <div class="grid grid-cols-2 grid-rows-1 gap-4">
                    <div>
                        <Form @submit="addPassageiro">
                            <div class="flex">
                                <TextInput nameValue="inputPassageiros" rulesValue="required" class="basis-4/5"
                                    label="Passageiros" />
                                <button
                                    ...
                                    <li v-for="(passageiro, index) in passageiros" :key="index">
                                        <div class="flex items-center justify-between px-3">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 cursor-pointer"
                                                @click="deletePassageiro(index)" fill="none" viewBox="0 0 24 24"
                                ...
                                <TransitionGroup>
                                    <li v-for="(item, index) in destinasePagamento" :key="index">
                                        <div class="flex items-center justify-between px-3">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 cursor-pointer"
                                                @click="deletePagamento(index)" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                            </svg>
...
const onSubmit = (values) => {
    ...
    const doc = pdfCreator(passageiros, destinasePagamento, Object.assign(values, { cartao: cartao.value }));
    pdfMake.fonts = {
        Roboto: {
            normal:
